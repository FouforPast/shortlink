...
package com.lyl.shortlink.project.dao.mapper;

import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import com.baomidou.mybatisplus.core.metadata.IPage;
import com.lyl.shortlink.project.dao.entity.LinkAccessLogsDO;
import com.lyl.shortlink.project.dao.entity.LinkAccessStatsDO;
...
import com.lyl.shortlink.project.dto.req.ShortLinkStatsReqDTO;
...
//            "    AND tlal.create_time BETWEEN CONCAT(#{param.startDate},' 00:00:00')  and CONCAT(#{param.endDate},' 23:59:59') " +
    ...
    @Select("SELECT " +
            ...
            "        CASE WHEN COUNT(DISTINCT DATE(tlal.create_time)) = 1 AND MAX(tlal.create_time) >= #{param.startDate} " +
