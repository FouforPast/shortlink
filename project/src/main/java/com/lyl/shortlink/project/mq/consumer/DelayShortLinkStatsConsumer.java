...
import static com.lyl.shortlink.project.common.constants.RedisCacheConstant.DELAY_QUEUE_STATS_KEY;
                ...
                .execute(() -> {
                    ...
                    for (; ; ) {
                        try {
                            ...
                            if (statsRecord != null) {
                                if (messageQueueIdempotentHandler.notMessageProcessed(statsRecord.getKeys())) {
                                    // 判断当前的这个消息流程是否执行完成
